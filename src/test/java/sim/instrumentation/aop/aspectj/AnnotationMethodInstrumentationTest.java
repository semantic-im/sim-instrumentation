 ...
 * 
 */
public class AnnotationMethodInstrumentationTest {
	private static final String className = AnnotationMethodInstrumentationTest.class.getName();
	...
	public void testMethod2() {
		assertFalse(isMethodInstrumented(className, "testMethod2"));
	}
}
